...
export const endpointCases: EndpointCase[] = [
  ...
  { module: 'admin', method: 'patch', path: '/admin/riders/1/approve', expectedWithoutAuth: 401 },
  {
    module: 'admin',
    method: 'patch',
    path: '/admin/riders/1/reject',
    body: {},
    expectedWithoutAuth: 401,
  },
  {
    module: 'admin',
    method: 'patch',
    path: '/admin/rider-documents/1/review',
    body: {},
    expectedWithoutAuth: 401,
  },
  ...
  { module: 'delivery', method: 'get', path: '/deliveries/offers', expectedWithoutAuth: 401 },
  {
    module: 'delivery',
    method: 'post',
    path: '/deliveries/offers/1/accept',
    expectedWithoutAuth: 401,
  },
  {
    module: 'delivery',
  ...
  { module: 'rbac', method: 'delete', path: '/rbac/roles/1/1', expectedWithoutAuth: 401 },
  {
    module: 'rbac',
    method: 'post',
    path: '/rbac/permission-overrides',
    body: {},
    expectedWithoutAuth: 401,
  },
...

  {
    module: 'riders',
    method: 'get',
    path: '/riders/onboarding/requirements',
    expectedWithoutAuth: 401,
  },
  { module: 'riders', method: 'get', path: '/riders/banks', expectedWithoutAuth: 401 },
  {
    module: 'riders',
    method: 'post',
    path: '/riders/bank-accounts/resolve',
    body: {},
    expectedWithoutAuth: 401,
  },
  ...
  },
  {
    module: 'riders',
    method: 'post',
    path: '/riders/kyc/verify-document',
    body: {},
    expectedWithoutAuth: 401,
  },
  {
    module: 'riders',
    method: 'post',
    path: '/riders/kyc/verify-guarantor-document',
    body: {},
    expectedWithoutAuth: 401,
  },
  { module: 'riders', method: 'get', path: '/riders/wallet', expectedWithoutAuth: 401 },
  {
    module: 'riders',
    method: 'get',
    path: '/riders/wallet/transactions',
    expectedWithoutAuth: 401,
  },
  {
    module: 'riders',
    method: 'post',
    path: '/riders/wallet/withdraw',
    body: {},
    expectedWithoutAuth: 401,
  },
  ...
  { module: 'stores', method: 'get', path: '/stores/1/wallet', expectedWithoutAuth: 401 },
  {
    module: 'stores',
    method: 'get',
    path: '/stores/1/wallet/transactions',
    expectedWithoutAuth: 401,
  },
  {
    module: 'stores',
    method: 'post',
    path: '/stores/1/wallet/withdraw',
    body: {},
    expectedWithoutAuth: 401,
  },
  {
    module: 'stores',
    method: 'get',
    path: '/stores/1/wallet/withdrawals',
    expectedWithoutAuth: 401,
  },
  ...
  },
  {
    module: 'marketplace',
    method: 'get',
    path: '/marketplace/products/1/compare',
    public: true,
    expectedWithoutAuth: [200, 404],
  },
  {
  ...
  },
  {
    module: 'marketplace',
    method: 'delete',
    path: '/marketplace/wishlist/1',
    expectedWithoutAuth: 401,
  },
  {
    module: 'marketplace',
    method: 'get',
    path: '/marketplace/compare-list',
    expectedWithoutAuth: 401,
  },
  {
    module: 'marketplace',
  ...
  },
  {
    module: 'marketplace',
    method: 'delete',
    path: '/marketplace/compare-list/1',
    expectedWithoutAuth: 401,
  },
];
